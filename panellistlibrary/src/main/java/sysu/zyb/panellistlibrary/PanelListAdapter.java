...
public abstract class PanelListAdapter {
    ...
    private String rowTitleBackGroundColor = "#607D8B";//default color of column
    private String titleBackGroundColor = "#CFD8DC";//default color of title
    private String columnTtitlBackGroundColor = "#ffffff";//default color of title
    /**
     * 设置各个标题的背景颜色
     * @param rowTitleBackGroundColor 行标题背景的颜色代码(要以#开头)
     * @param titleBackGroundColor 标题背景的颜色代码(要以#开头)
     * @param columnTtitlBackGroundColor  列标题背景的颜色代码(要以#开头)
     */
    public void setTitleBackGroundColor(String rowTitleBackGroundColor,String titleBackGroundColor,String columnTtitlBackGroundColor) {
        this.rowTitleBackGroundColor = rowTitleBackGroundColor;
        this.titleBackGroundColor = titleBackGroundColor;
        this.columnTtitlBackGroundColor = columnTtitlBackGroundColor;
    }



    private String rowTitleTextColor = "#ffffff";//default color of column text
    private String titleTextColor = "#CFD8DC";//default color of title text
    private String columnTitleTextColor = "#ffffff";//default color of title text
    /**
     * 设置各个标题字体的颜色
     * @param rowTitleTextColor 行标题字体的颜色代码(要以#开头)
     * @param titleTextColor 行标题字体的颜色代码(要以#开头)
     * @param columnTitleTextColor 标题字体的颜色代码(要以#开头)
     */
    public void setTitleTextColor(String rowTitleTextColor,String titleTextColor,String columnTitleTextColor) {
        this.rowTitleTextColor = rowTitleTextColor;
        this.titleTextColor = titleTextColor;
        this.columnTitleTextColor = columnTitleTextColor;
    }

    private String setNeedToSortColumnTitleTextColor="#FF0000";//如果要某一列有排序功能时，被选中的列标题颜色
    private int firstSortPosition=0;//第一个能实现排列功能的标题的位置
    public void setNeedToSortColumnTitleTextColor(String setNeedToSortColumnTitleTextColor,int firstSortPosition){
        this.setNeedToSortColumnTitleTextColor=setNeedToSortColumnTitleTextColor;
        this.firstSortPosition=firstSortPosition;
    }
    ...
    private void reorganizeViewGroup() {
        ...
        tv_title.setText(title);//设置左上标题的文字
        tv_title.setTextColor(Color.parseColor(titleTextColor));
        tv_title.getPaint().setFakeBoldText(true);
        tv_title.setGravity(Gravity.CENTER);
        tv_title.setBackgroundColor(Color.parseColor(titleBackGroundColor));//设置标题的背景颜色
...
//                lv_column.setAdapter(getColumnAdapter());
        ...
        lv_column.setBackgroundColor(Color.parseColor(rowTitleBackGroundColor));//设置行标题的背景颜色
...
//        lv_column.setDivider(context.getResources().getDrawable(R.drawable.column_item_divider));
        ...
        mhsv_content.setScrollBarStyle(View.SCROLLBARS_INSIDE_OVERLAY);
    ...
    private void setColumnTitleWidth(int columnTitleWidth){
        if(columnTitleWidth!=0){
            this.columnTitleWidth=columnTitleWidth;
        }
    }
    public int getColumnTitleWidth(){
        return columnTitleWidth;
    }

    private boolean isClick=false;
    public void setColumnTitleClick(boolean isclick){
    ...
    private void initRowLayout(){
        ...
        ll_row.setBackgroundColor(Color.parseColor(columnTtitlBackGroundColor));//设置列标题的背景颜色
        ...
        for (int i = 0;i<rowCount; i++){//设置列的标题
            View contentItem = ll_contentItem.getChildAt(i);// 获得item的item，以便获取宽度
            TextView rowItem = new TextView(context);
            if(isClick){
                if(i==firstSortPosition){
                    rowItem.setText(rowDataList.get(i)+"↓");//这里设置初始化的页面时候的第一项的问题
                    rowItem.setTextColor(Color.parseColor(setNeedToSortColumnTitleTextColor));
                }else {
                    rowItem.setText(rowDataList.get(i));//设置文字
                    rowItem.setTextColor(Color.parseColor(columnTitleTextColor));
                }
                rowItem.setId(2000+i);
                rowItem.setTag(i);
                rowItem.setOnClickListener(listener);
                textViewList.add(rowItem);
            }else {
                rowItem.setText(rowDataList.get(i));//设置文字
                rowItem.setTextColor(Color.parseColor(columnTitleTextColor));
            }
    ...
    public void setTitleWidth(List<Integer> list) {
        columnWidthList=list;
    }

    List<TextView> textViewList=new ArrayList<>();
    //获取列标题的textView集合
    public List<TextView> getRowItemTextView(){
...
//                    Log.d("ybz", "onScrollStateChanged: top = "+top);
    ...
    private class ColumnAdapter extends ArrayAdapter{
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            ((TextView)view).setTextColor(Color.parseColor(rowTitleTextColor));
