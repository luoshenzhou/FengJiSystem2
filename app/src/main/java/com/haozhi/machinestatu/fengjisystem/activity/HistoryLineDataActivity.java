...
import com.haozhi.machinestatu.fengjisystem.chart.Model;
import com.haozhi.machinestatu.fengjisystem.chart.StockListBean;
 ...
 */
public class HistoryLineDataActivity extends Base_TitleBar_Activity {
    @Bind(R.id.chart)
